...
import com.giatrong.learning.learnspringapi.dto.response.User.UserListResponse;
...
public class UserController {
    ...
    @GetMapping
    @Operation(summary = "Get all users, filter and search user", description = "Retrieve a list of all users")
    public ResponseEntity<ApiResponse<UserListResponse>> getAllUsers(
            @ParameterObject UserListRequest userListRequest,
            @ParameterObject Pageable pageable) {
        Page<UserDto> users = userService.getAllUsers(userListRequest, pageable);
        ApiResponse<UserListResponse> apiResponse = ApiResponse.success(new UserListResponse(users, userListRequest), "Get all users successfully", HttpStatus.OK.value());
